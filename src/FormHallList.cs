...
{
    public partial class FormHallList : Form
    {
        public FormHallList()
        {
            InitializeComponent();
        ...
        private void FormHallList_Load(object sender, EventArgs e)
        {
        ...
        private static FormHallList f;
        public static FormHallList formHall
        {
            get
            {
                if (f == null || f.IsDisposed) f = new FormHallList();
                return f;
            }
        }
